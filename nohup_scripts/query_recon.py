...
def main():
    ...
    ref_dir = Path("/media/siyanhu/Changkun/Siyan/Tramway/process/lidar_rgb3/frames_2025")
    queries_dir  = Path("/media/siyanhu/Changkun/Siyan/Tramway/process/lidar_rgb3/frames/2024")
    skip_query_seq_from_ref = ["2024"]
    outputs_ref = Path("/media/siyanhu/Changkun/Siyan/Tramway/process/lidar_rgb3/hloc_2025")
